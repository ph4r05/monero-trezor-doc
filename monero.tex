...
\begin{enumerate}
	...
	\begin{enumerate}			
        ...
        - Generate mask scalars for each bit in the output amount $a_{i, j}, j \in [0, 63]$. \\
        ...
        \item HMAC the output transaction data HMAC($T_{out,i} \; || \; tx.vout_i \; $) with HMAC key: $H(k_{hmac} \; || \; \text{"txout"} \; || \; i)$.
        
        \item HMAC range proof HMAC($rsig$) with HMAC key: $H(k_{hmac} \; || \; \text{"txout-asig"} \; || \; i)$.
