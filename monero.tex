...
Thanks to the \emph{final\_message} hash structure it is possible to incrementally hash range proof during the generation time. Once the range proof is generated it is not transfered to the device anymore.
