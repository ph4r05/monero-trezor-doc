...
The integration idea is to do minimal modifications to the official Monero codebase so the integration maintainability is increased. We aim to add minimal features required for our use case to the Monero codebase. 
