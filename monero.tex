...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Generate the key derivation $\mathcal{D}_{out}$, amount key.
        \item Store the amount key in the Trezor transaction state.
...
\begin{figure}[H]
	...
	\caption{Detailed transaction state for incremental signing}
\end{figure}
