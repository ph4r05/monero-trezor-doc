...
The current software wallet implementation may generate multiple pending transactions while only one is sent eventally. 
...
\begin{enumerate}
	...
	\item T: Reset transaction state, store new transaction data.
