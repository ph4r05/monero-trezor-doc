...
\begin{table}[H]
	...
	\end{tabular}
	\end{center}
	\caption{BP performance on the Trezor. Computation times for $M > 4$ are higher as the precomputed vectors are only up to the $4$ statements and the rest of the used vector has to be computed additionally. }
\end{table}
